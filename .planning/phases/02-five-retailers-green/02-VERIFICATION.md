...
| CR-02 guard is not vacuous — it BITES | Appended `true-client-ip: 203.0.113.77 city=AUSTIN zip=78701` to a shipped fixture, ran the guard test | `FAILED test_no_fixture_leaks_the_capturing_hosts_identity` — flagged all four markers. Restored; tree clean; test passes | ✓ PASS |
