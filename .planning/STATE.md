...
**Current focus:** **Milestone v0.4 — Don't Get Locked Out. Phases 8 and 9 are COMPLETE IN THE TREE as of
2026-08-31 and 2026-09-01; neither is on the wire.** Phase 10 (A Control That Cannot Die) is next and makes no
live retailer request. **Phase 11 must not start without asking Dan** — it spends a live probe budget at the three
retailers already refusing us. See `.planning/ROADMAP.md` for both closing records.
