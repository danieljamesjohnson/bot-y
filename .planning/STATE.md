...
stopped_at: DEPLOYED v0.3 on 2026-08-20 07:43:22 CDT at Dan's instruction — `sudo systemctl restart boty`, PID 547119 -> 548295, NRestarts=0. state.json migrated 13 -> 13 entries, ZERO lost, every availability byte-identical; status.json 3 -> 13 watch rows all carrying read_at and checked; 6 retailer rows gained a real cadence. Page looked at with headless Chromium: 5 real ages, 8 amber `AGE ?`, zero console errors. IN-03 fixed first (a1f61f7) so a payload the page cannot render says so instead of freezing. Pin still deferred; no tag; nothing pushed
last_updated: "2026-08-24T13:10:56.000Z"
