...
- ✅ **Milestone v0.3 — Say When You Measured It** (scoped 2026-08-13, closed 2026-08-19) — Phase 7, 7 plans, one requirement (REQ-21), complete **in the tree**; **not deployed, not tagged, not published** — the running daemon predates the milestone's first commit by ~15 hours. Archived in full: [`milestones/v0.3-ROADMAP.md`](milestones/v0.3-ROADMAP.md) · [`milestones/v0.3-REQUIREMENTS.md`](milestones/v0.3-REQUIREMENTS.md) · [`milestones/v0.3-MILESTONE-AUDIT.md`](milestones/v0.3-MILESTONE-AUDIT.md)
